...
{
//DEBUG function
std::string GaloisFieldDict::__str__() const {
    RCP<const GaloisField> gf = GaloisField::from_vec(symbol("x"),this->dict_,this->modulo_);
    return gf->__str__();
}
...
{
    cout << "body of gf_edf_zassenhaus.  this = " << this->__str__() << endl;
