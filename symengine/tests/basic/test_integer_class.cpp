...
TEST_CASE("factors and multiples: integer_class", "[integer_class]")
{
	...
	REQUIRE(gcd == 1); REQUIRE(s == 0); REQUIRE(t == -1);
	mp_gcdext(gcd, s, t, -1, 0);
	REQUIRE(gcd == 1); REQUIRE(s == -1); REQUIRE(t == 0);
	mp_gcdext(gcd, s, t, -1, 1);
	REQUIRE(gcd == 1); REQUIRE(s == 0); REQUIRE(t == 1);
	mp_gcdext(gcd, s, t, 0, -1);
	REQUIRE(gcd == 1); REQUIRE(s == 0); REQUIRE(t == -1);
	//mp_gcdext(gcd, s, t, 0, 0);
	//REQUIRE(gcd == 0); REQUIRE(s == 0); REQUIRE(t == 0); //fails for boostmp but not gmp
	mp_gcdext(gcd, s, t, 0, 1);
	REQUIRE(gcd == 1); REQUIRE(s == 0); REQUIRE(t == 1);
	mp_gcdext(gcd, s, t, 1, -1);
	REQUIRE(gcd == 1); REQUIRE(s == 0); REQUIRE(t == -1);
	...
	REQUIRE(gcd == 2); REQUIRE(s == 1); REQUIRE(t == 0);
	mp_gcdext(gcd, s, t, 2, 1);
	REQUIRE(gcd == 1); REQUIRE(s == 0); REQUIRE(t == 1);
	mp_gcdext(gcd, s, t, 2, 2);
	REQUIRE(gcd == 2); REQUIRE(s == 0); REQUIRE(t == 1);
	...
	REQUIRE(gcd == 1); REQUIRE(s == -1); REQUIRE(t == 1);
	...
	REQUIRE(gcd == 4); REQUIRE(s == -1); REQUIRE(t == 1);
...
TEST_CASE("fibonacci and lucas: integer_class", "[integer_class]")
{
	...
	REQUIRE(res == 34); REQUIRE(res2 == 21);
	...
	REQUIRE(res == 47); REQUIRE(res2 == 29);
}
...
TEST_CASE("misc: integer_class", "[integer_class]")
{
	...
	REQUIRE(mp_get_ui(integer_class("-18446744073709551615")) == 18446744073709551615u);
	REQUIRE(mp_get_ui(integer_class("-9223372036854775809")) == 9223372036854775809u);
	REQUIRE(mp_get_ui(integer_class("-9223372036854775808")) == 9223372036854775808u);
	REQUIRE(mp_get_ui(integer_class("-2")) == 2u);
	REQUIRE(mp_get_ui(integer_class("-1")) == 1u);
	REQUIRE(mp_get_ui(integer_class("0")) == 0u);
	REQUIRE(mp_get_ui(integer_class("1")) == 1u);
	REQUIRE(mp_get_ui(integer_class("2")) == 2u);
	REQUIRE(mp_get_ui(integer_class("9223372036854775807")) == 9223372036854775807u);
	REQUIRE(mp_get_ui(integer_class("-9223372036854775807")) == 9223372036854775807u);
	REQUIRE(mp_get_ui(integer_class("18446744073709551615")) == 18446744073709551615u);
	REQUIRE(mp_get_ui(integer_class("18446744073709551615")) == 18446744073709551615u);
	REQUIRE(mp_get_ui(integer_class("18446744073709551616")) == 0u);
	...
	rational_class p;
	mp_pow_ui(p,r,4);
	REQUIRE(get_num(p) == 16); REQUIRE(get_den(p) == 81);
}
